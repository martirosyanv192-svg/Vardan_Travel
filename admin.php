...
function updateBookingStatus(id, newStatus) {
    ...
    // Փոխանցվող պարամետրերը EmailJS Տրաֆարետին (Template-ին)
    ...
    // EmailJS Ուղարկում
    // ⚠️ Փոխարինեք YOUR_SERVICE_ID-ն և YOUR_TEMPLATE_ID-ն ձեր EmailJS dashboard-ի ID-ներով
